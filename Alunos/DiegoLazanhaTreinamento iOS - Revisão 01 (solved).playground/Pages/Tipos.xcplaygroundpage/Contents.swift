...
func sum(oper1:Double, oper2:Double) ->Double {
    return oper1 + par2
}

func subtraction(oper1:Double, oper2:Double) ->Double{
    return oper1 - oper2
}

func multiplication(oper1:Double, oper2:Double) ->Double {
    return oper1 * oper2
}
...
var sumResult = sum(oper1: par1, oper2: par2)
var subResult = subtraction(oper1: par1, oper2: par2)
var mulResult = multiplication(oper1: par1, oper2: par2)
var divResult = division(oper1: par1, oper2: par2)
