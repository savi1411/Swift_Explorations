...
print("No meio do caminho tinha uma pedra") // PR1
print("Tinha uma pedra no meio do caminho") // PR2
print("Tinha uma pedra")                    // PR3
print("No meio do caminho tinha uma pedra") // PR1
...
// Conclusão
//  Com o uso de funções, o código ficou mais organizado (modularizado)
//  Porém, não diminuímos o número de linhas
/*:
