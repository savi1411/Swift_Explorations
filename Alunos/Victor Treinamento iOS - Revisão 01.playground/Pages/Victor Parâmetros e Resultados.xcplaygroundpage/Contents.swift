...
let generalPassword: String = "123ICantChange"
let generalUser: String = "User123"
...
loginVerification(userTyped: userTyped, passwordTyped: passwordTyped)
...
func loginVerification(userTyped: String, passwordTyped:String){
