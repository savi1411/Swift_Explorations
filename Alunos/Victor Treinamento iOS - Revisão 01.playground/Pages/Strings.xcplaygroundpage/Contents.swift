...
let travelString = "viajar"
let vacationString = "férias"
let loveString = "amor"
let livingString = "viver"

print("Eu vou \(travelString), vou passear,\(livingString) de \(loveString) Junto com você meu \(loveString) vou ter, \(livingString) de \(loveString) Como é lindo amar, como é bom sonhar, \(livingString) de \(loveString) Vamos conhecer coisas do \(livingString), \(livingString) de \(loveString)")
