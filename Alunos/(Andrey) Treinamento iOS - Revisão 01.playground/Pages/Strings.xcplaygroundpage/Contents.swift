...
print("eu vou \(viajar), vou passear, \(viver) de \(ferias) junto com meu \(amor) vou ter, \(ferias) de \(amor). Como é lindo amar, como é bom sonhar, \(ferias) de \(amor). Vamos conhecer coisas do \(viver), \(ferias) de \(amor)")
