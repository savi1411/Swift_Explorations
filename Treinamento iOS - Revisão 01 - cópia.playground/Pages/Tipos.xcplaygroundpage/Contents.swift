...
func subtraction(par1, par2) {
    return par1 - par2
}

func multiplication(par1, par2) {
    return par1 * par2
}

func division(par1, par2) {
    return par1 / par2
}
...
var sumResult = sum(par1, par2)
var subResult = subtraction(par1, par2)
var mulResult = multiplication(par1, par2)
var divResult = division(par1, par2)
