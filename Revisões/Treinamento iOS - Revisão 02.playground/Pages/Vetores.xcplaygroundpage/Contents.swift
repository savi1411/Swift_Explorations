...
shoppingList.insert("Choco", at: 4)
shoppingList.insert("Beer", at: 4)
shoppingList.insert("Oranges", at: 4)
shoppingList.insert("White Wine", at: 4)
shoppingList.remove(at: 3)
shoppingList[0] = "A dozen eggs"
shoppingList
