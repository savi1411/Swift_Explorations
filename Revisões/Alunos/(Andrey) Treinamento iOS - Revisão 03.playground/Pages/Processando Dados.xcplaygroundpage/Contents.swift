...
for show in tabulator.tabulatedValues {
    if show.count < median - medianAbDev {
        ...
        moderatelyPopular.insert(show, at: 0)    }
}
...
var ordemCrescente = [TabulatedValue]()
var ordemDecrescente = [TabulatedValue]()

//for show in tabulator.tabulatedValues {
//    ordemCrescente.append(show)
//}
//ordemCrescente.sort()
//
...
//for show in ordemCrescente {
//    ordemDecrescente.insert(show, at: 0)
//}
...
func teste(ordem: String) -> [TabulatedValue]{
   
    var msg = [TabulatedValue]()
    ...
    if ordem == "Decrescente"{
        ...
        msg = ordemDecrescente
        
    }
    return msg
}

print(teste(ordem: "Decrescente"))
