...
var flightB = FlightClasssStruct(id: 200, description: "first ever flight of Virgin Airlines", destination: "london", airlines: "Virgin Airlines", status: "delayed")
...
flightB.flightStatus(id: 100)
flightB.flightStatus(id: 200)
/*:
