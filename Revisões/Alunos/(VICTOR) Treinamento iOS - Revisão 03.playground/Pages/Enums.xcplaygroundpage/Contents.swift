...
enum zodiacKillerMenu{
    case dezembro, janeiro, fevereiro, marco, abril, maio, junho, julho, agosto, setembro, outubro, novembro
    //Propriedade Calculado
    var signo:String{
        switch self {
        case .dezembro:
            if day < 22 { return "♐️ - Sargitario" } else { return  "♑️ - Capricórnio" }
        case .janeiro:
            if day < 20 { return "♑️ - Capricórbio" } else { return "♒️ - Aquário" }
        case .fevereiro:
        ...
        case .maio:
            if day < 21 { return "♉️ - Touro" } else { return "♊️ - Gemeos" }
        case .junho:
            if day < 21 { return "♊️ - Gemeos" } else { return "♋️ - Cancer" }
        case .julho:
            if day < 23 { return "♋️ - Cancer" } else { return "♌️ - Leão" }
        case .agosto:
        ...
        case .novembro:
            if day < 22 { return "♏️ - Escorpião" } else { return "♐️ - Sargitario" }
        }
    }
}
...
day = 17
let month2 = zodiacKillerMenu.maio
//var sign2 = String()
print("Seu signo é \(month2.signo)")
