...
var popularityRanking = [TabulatedValue]()

for show in notVeryPopular {
    popularityRanking.append(show)
}
for show in moderatelyPopular {
    popularityRanking.append(show)
}
for show in veryPopular{
    popularityRanking.append(show)
}

print("\(popularityRanking)\n")
//popularityRanking.sort()
print("\(popularityRanking)\n")
...
func rankingListArray(elementos:[TabulatedValue]) {
    
    var ranked = [TabulatedValue]()
    for elemento in elementos{
        ranked.append(elemento)
    }
    
    ranked.sort()
    if isCrescent{
//        ranked.sort()
        print("A lista em ordem Crescente é: \(ranked)\n")
    } else {
        ranked.reverse()
        print("A lista em ordem Decrecente é: \(ranked)\n")

    }
}

rankingListArray(elementos: popularityRanking)
