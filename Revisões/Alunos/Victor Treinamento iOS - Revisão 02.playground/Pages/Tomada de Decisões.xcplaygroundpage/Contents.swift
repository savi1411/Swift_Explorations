...
if userPhrase.lowercased().contains("acorde") || userPhrase.lowercased().contains("alarme"){
    print("Novo Alarme registrado")
}else{
...
switch userPhrase.lowercased().contains("alarme") || userPhrase.lowercased().contains("acorde") {
case true:
    print("Novo Alarme registrado")
