...
struct FlightStruct {
    ...
    func flightStatus1(id: Int) -> String {
        if self.id == id {
            return status
        } else {
            return "vôo não encontrado"
...
var flightB = FlightStruct(id: 100, description: "first ever flight of Virgin Airlines", destination: "london", airlines: "Virgin Airlines", status: "delayed")
...
flightB.flightStatus1(id: 100)
flightB.flightStatus1(id: 200)
...
flightB.status
var flightC1 = flightB
flightC1.status = "scheduled"
flightC1.status
flightB.status      // !?!?!? Como isso é possível !?!?!?
